...
function MyComponent() {
  ...
  // pick autogenerated mutations
  const { pushItems, updateItems, removeItems } = useModule(MyModule);

  // ADD NEW ITEM
  pushItems({ id: 3, name: 'Item 3' });

  // remove item with name = 'Item 3'
  removeItems({ name: 'item 3' });

  // remove items with name = 'Item 3'
  removeItems(item => item.name === 'Item 3');

  // rename `Item 3`
  updateItems({ name: 'Item 3' }, { name: 'Renamed Item 3' });

  // rename `Item 3`
  updateItems(
    item => item.name === 'Item 3',
    item => item.name = 'Renamed Item 3',
  );
}
