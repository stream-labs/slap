...
export declare type GetStateControllerFor<TConfigCreator, TDraftConfig = TDraftConfigFor<TConfigCreator>, TState = PickDefaultState<TDraftConfig>> = StateController<TConfigCreator> & TState & Omit<PickAutogeneratedMutations<TState>, keyof PickMethods<TDraftConfig>> & PickAutogeneratedPushMutations<TConfigCreator> & PickAutogeneratedRemoveMutations<TConfigCreator> & PickDefaultMutations<TState> & PickAutogeneratedEvents<TConfigCreator> & PickMethods<TDraftConfig> & Exclude<TDraftConfig, keyof TStateConfig>;
