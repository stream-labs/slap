...
export declare class Store {
    ...
    getController(moduleName: string, sectionName: string): ModuleStateController<any>;
...
export declare class ModuleStateController<TConfig = any> {
    store: Store;
    moduleName: string;
    sectionName: string;
    draftState: any;
