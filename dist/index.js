...
__webpack_require__.d(__webpack_exports__, {
  ...
  "createNextState": () => (/* reexport */ immer_esm["default"]),
  ...
  "current": () => (/* reexport */ immer_esm.current),
  "findNonSerializableValue": () => (/* binding */ findNonSerializableValue),
  "freeze": () => (/* reexport */ immer_esm.freeze),
  ...
  "isDraft": () => (/* reexport */ immer_esm.isDraft),
  ...
  "original": () => (/* reexport */ immer_esm.original),
  "unwrapResult": () => (/* binding */ unwrapResult)
});

// EXTERNAL MODULE: ./node_modules/immer/dist/immer.esm.js
var immer_esm = __webpack_require__(172);
...
var createDraftSafeSelector = function () {
    ...
    var wrappedSelector = function (value) {
        ...
        return selector.apply(void 0, __spreadArray([(0,immer_esm.isDraft)(value) ? (0,immer_esm.current)(value) : value], rest));
    };
...
function createReducer(initialState, mapOrBuilderCallback, actionMatchers, defaultCaseReducer) {
    ...
    if (isStateFunction(initialState)) {
        getInitialState = function () { return (0,immer_esm["default"])(initialState(), function () {
        }); };
    }
    else {
        var frozenInitialState_1 = (0,immer_esm["default"])(initialState, function () {
        });
    ...
    function reducer(state, action) {
        ...
        return caseReducers.reduce(function (previousState, caseReducer) {
            if (caseReducer) {
                if ((0,immer_esm.isDraft)(previousState)) {
                ...
                else if (!(0,immer_esm.isDraftable)(previousState)) {
                    ...
                    return (0,immer_esm["default"])(previousState, function (draft) {
...
function createSlice(options) {
    ...
    var initialState = typeof options.initialState == "function" ? options.initialState : (0,immer_esm["default"])(options.initialState, function () {
    });
...
function createStateOperator(mutator) {
    return function operation(state, arg) {
        ...
        if ((0,immer_esm.isDraft)(state)) {
            runMutator(state);
            return state;
        }
        else {
            return (0,immer_esm["default"])(state, runMutator);
        }
    };
}
 ...
 */
const toolkit_1 = __webpack_require__(137);
